...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? DisposerHomeWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'disposer_home',
          path: '/disposerHome',
          builder: (context, params) => DisposerHomeWidget(),
        ),
        FFRoute(
          name: 'category_details_test',
          path: '/categoryDetailsTest',
          builder: (context, params) => CategoryDetailsTestWidget(),
        ),
        FFRoute(
          name: 'image',
          path: '/image',
        ...
        FFRoute(
          ...
          builder: (context, params) => ContributionTypeWidget(),
        ),
        FFRoute(
          name: 'selling_price',
          path: '/sellingPrice',
          builder: (context, params) => SellingPriceWidget(),
        ),
        FFRoute(
          name: 'contribute_to',
          path: '/contributeTo',
        ...
        FFRoute(
          name: 'acccount_profile',
          path: '/acccountProfile',
          builder: (context, params) => AcccountProfileWidget(),
        ),
        FFRoute(
          name: 'create_post',
          path: '/createPost',
        ...
        FFRoute(
          ...
          path: '/searchOrganisation',
          builder: (context, params) => SearchOrganisationWidget(),
        ),
        FFRoute(
          name: 'my_posts',
          path: '/myPosts',
        ...
        FFRoute(
          name: 'imageCopy',
          path: '/imageCopy',
          builder: (context, params) => ImageCopyWidget(),
        ),
        FFRoute(
          name: 'recycler_home',
          path: '/recyclerHome',
          builder: (context, params) => RecyclerHomeWidget(),
        ),
        FFRoute(
          name: 'shop',
          path: '/shop',
